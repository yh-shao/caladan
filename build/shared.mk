...
ifneq ($(SHAOFS_TIMING_BREAKDOWN),)
FLAGS += -DSHAOFS_TIMING_BREAKDOWN=1
endif

ifneq ($(SHAOFS_TIMING_STATS),)
FLAGS += -DSHAOFS_TIMING_STATS=1
endif

ifneq ($(SHAOFS_TIMING_STATS_TARGET),)
FLAGS += -DSHAOFS_TIMING_STATS_TARGET=$(SHAOFS_TIMING_STATS_TARGET)
endif

ifneq ($(SHAOFS_TIMING_STATS_SKIP),)
FLAGS += -DSHAOFS_TIMING_STATS_SKIP=$(SHAOFS_TIMING_STATS_SKIP)
endif

ifneq ($(SHAOFS_TIMING_STATS_DUMP_SAMPLES),)
FLAGS += -DSHAOFS_TIMING_STATS_DUMP_SAMPLES=$(SHAOFS_TIMING_STATS_DUMP_SAMPLES)
endif
